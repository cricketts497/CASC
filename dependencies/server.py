...
pvdb["Heinzinger30k:VoltageSetpoint"] = {'type':'int', 'hihi':30000, 'unit':'V'}
pvdb["Heinzinger30k:CurrentSetpoint"] = {'type':'float', 'high':1, 'hihi':3, 'unit':'mA'}
pvdb["Heinzinger30k:OutputSetpoint"] = {'type':'enum', 'enums':['OutputOff','OutputOn','off'], 'value':2}
pvdb["Heinzinger30k:VoltageApplied"] = {'type':'float', 'hihi':30000, 'unit':'V'}
